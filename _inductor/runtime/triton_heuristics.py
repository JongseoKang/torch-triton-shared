...
class TritonCompileResult:
    ...
    def make_launcher(self) -> LauncherType:
        ...
        scope = {
            ...
            "bin": binary,
            "launch_enter_hook": binary.__class__.launch_enter_hook if hasattr(binary.__class__, "launch_enter_hook") else None, ### modified
            "launch_exit_hook": binary.__class__.launch_exit_hook if hasattr(binary.__class__, "launch_exit_hook") else None, ### modified
            "metadata": (
        ...
        if not hasattr(binary, "launch_metadata"):
            ...
            if binary.__class__.launch_enter_hook if hasattr(binary.__class__, "launch_enter_hook") else None: ### modified
